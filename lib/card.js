...
// TODO: 
//
// 1) If nextRepetitionInterval is a fraction, round it up to the nearest integer.
//
// 2) If the quality response was lower than 3 then start repetitions for the item
// from the beginning without changing the E-Factor (i.e. use intervals I(1),
// I(2) etc. as if the item was memorized anew).
//
// 3) After each repetition session of a given day repeat again all items that
